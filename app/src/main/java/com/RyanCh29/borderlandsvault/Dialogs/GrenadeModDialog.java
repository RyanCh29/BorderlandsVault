...
//                .setTitle("Choose Gear to Add")
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listener.addGrenadeMod(score,lvl,name,type,dmg,accuracy,handling,reload,fireRate,magazine,redText);
                    }
                });
    ...
    public interface GrenadeModDialogListener {
        void addGrenadeMod(String score, String lvl, String name, String type, String dmg,
