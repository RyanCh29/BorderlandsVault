...
//                .setTitle("Choose Gear to Add")
                ...
                .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listener.addArtifact(score,lvl,name,type,dmg,accuracy,handling,reload,fireRate,magazine,redText);
                    }
                });
    ...
    public interface ArtifactDialogListener {
        void addArtifact(String score, String lvl, String name, String type, String dmg,
